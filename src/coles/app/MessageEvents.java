...
public class MessageEvents extends ListActivity {
    ...
    public void onCreate(Bundle icicle) {
        ...
        TextView eventTitle = (TextView) findViewById (R.id.titleTextView);
	...
	private void loadFeed(ParserType type){
    	try{
	    	...
	    	FeedParser parser = feedparserfactory1.getParser(type);
