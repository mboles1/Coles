...
public class TextHandler extends DefaultHandler {
	...
	// this holds the data
	private ArrayList<Text2> _data = new ArrayList<Text2>();
	 ...
	 * @return
	 */
	public ArrayList<Text2> getData() {
		return _data;
	}
...
//		Log.d(TAG, localName);
		if(localName.equals("text_row")) {
			_text_row = false;
			Text2 t = new Text2(id, menu_no, item_order, heading, body, link);
